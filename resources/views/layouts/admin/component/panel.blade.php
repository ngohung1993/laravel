...
<div>
    <?php foreach (FunctionHelpers::get_custom_fields() as $key => $component): ?>
    <div class="theme-editor__panel" id="panel-<?= $component['id'] ?>" tabindex="-1">
        ...
        <div class="theme-editor__panel-body">
            <?php if ($component['type'] == CustomField::TYPE_SETTING): foreach (FunctionHelpers::get_custom_fields_by_parent_id($component['id'], 1) as $children) : $children = (array)$children ?>
            <section class="next-card theme-editor__card">
                <section class="next-card__section">
                    ...
                    <?php foreach (FunctionHelpers::get_custom_fields_by_parent_id($children['id']) as $attribute): $attribute = (array)$attribute ?>
                        ...
                        <div class="next-input-wrapper">
                            <div class="checkbox">
                                <input title="" class="minimal" type="checkbox"
                                       ...
                                       onchange="editor.main.override_theme_editor('<?= $attribute['key'] . '--status' ?>','checkbox',this)"
                            ...
                            <div class="next-grid__cell">
                                <div data-image-actions="" style="display:block;">
                                    <a style="background: #fff!important;-webkit-appearance: none;"
                                       href="{{asset('library/filemanager/dialog.php?type=1&field_id=custom-field-'.$attribute['key'])}}"
                    ...
                    <div class="theme-setting theme-setting--text">
                        ...
                        <input title="" type="text" class="next-input"
                               ...
                               id="custom-field-<?= $attribute['key'] ?>-value" value="<?= $attribute['value'] ?>">
                    </div>
                    <?php if ($attribute['description']): ?>
                        ...
                        <div class="next-input-wrapper">
                            <div class="ui-select__wrapper next-input--has-content">
                                <select title="" id="setting-home-section" class="ui-select valid"
                                    ...
                                    <?php foreach (FunctionHelpers::get_custom_fields_by_type(CustomField::TYPE_SECTION) as $key => $value): ?>
            ...
            <?php foreach (FunctionHelpers::get_custom_fields_by_parent_id($component['id']) as $children):$children = (array)$children;  if ($children['type'] == CustomField::TYPE_SECTION) : ?>
            <section class="next-card theme-editor__card">
                <section class="next-card__section">
                    <header class="next-card__header theme-setting theme-setting--header">
                        <h3 class="ui-subheading">
                        ...
                        <div class="next-input-wrapper">
                            <div class="checkbox" id="setting-checkbox-<?= $children['key'] ?>-enable">
                                <input title="" type="checkbox"
                                       onchange="editor.main.override_theme_editor('<?= $children['key'] ?>--status','checkbox',this)"
                        ...
                        <div class="next-grid next-grid--no-padding next-grid--vertically-centered"
                            ...
                            <div class="next-grid__cell theme-setting__image-preview">
                                <div
                                    ...
                                    <div class="next-grid__cell next-grid__cell--no-flex"
                                         style="background-color:#fafbfc;border: 1px solid #e6e8ea">
                                        <img src="{{asset($children['avatar'])}}" style="width:100%"
                            ...
                            <div class="next-grid__cell">
                                <div data-image-actions="" style="display:block;">
                                    <a style="background: #fff!important;-webkit-appearance: none;"
                                       href="{{asset('library/filemanager/dialog.php?type=1&field_id=img-setting-'. $children['key'] .'-png')}}"
                ...
                <?php foreach (FunctionHelpers::get_custom_fields_by_parent_id($children['id']) as $section): $section = (array)$section ?>
                            ...
                            <div class="next-grid next-grid--no-padding next-grid--vertically-centered"
                                ...
                                <div class="next-grid__cell theme-setting__image-preview">
                                    <div
                                        ...
                                        <div class="next-grid__cell next-grid__cell--no-flex"
                                             style="background-color:#fafbfc;border: 1px solid #e6e8ea">
                                            <img src="{{asset($section['avatar'])}}" style="width:100%"
                                ...
                                <div class="next-grid__cell">
                                    <div data-image-actions="" style="display:block;">
                                        <a style="background: #fff!important;-webkit-appearance: none;"
                                           href="{{asset('library/filemanager/dialog.php?type=1&field_id=img-setting-'. $section['key'] .'-png')}}"
