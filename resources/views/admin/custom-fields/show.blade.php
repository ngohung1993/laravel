...
/* @var $custom_field \App\CustomField */

?>

@extends('layouts.admin.main')

@section('title', $custom_field->title)
    ...
    <div class="page-content-wrapper">
        <div class="page-content " style="min-height: 986px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= url('admin/custom-fields') ?>">Cấu hình</a></li>
                <li class="breadcrumb-item active">{{$custom_field->title}}</li>
            </ol>
                            ...
                            <div class="widget meta-boxes">
                                ...
                                <div class="widget-body">
                                    <div class="box-header" style="padding: 0;">
                                        ...
                                        <div class="btn-group">
                                            <a class="btn btn-success btn-sm tree-5aa383cc537d1-save"
                                               data-parent-id="{{$custom_field->id}}">
                                                <i class="fa fa-save"></i>
                                                Lưu và làm mới
                                            </a>
                                        </div>
                                        <div class="btn-group">
                                            <a href="<?= url('admin/custom-fields/' . $custom_field->id) ?>"
                                    ...
                                    <div class="dd nestable-menu" id="tree-5aa383cc537d1">
                                        <?php App\Helpers\FunctionHelpers::show_custom_fields_nestable(App\CustomField::all(), $custom_field->id) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
