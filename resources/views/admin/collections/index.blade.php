...
/* @var $collections array \App\Collections */

?>

@extends('layouts.admin.main')

@section('title', 'Danh sách hiển thị')

@section('content')
    <div class="page-content " style="min-height: 602px;">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= url('admin/dashboard') ?>">Bảng điều khiển</a></li>
            <li class="breadcrumb-item active">Danh sách hiển thị</li>
        </ol>
                    ...
                    <div class="table-responsive">
                        <div class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            <div class="dt-buttons btn-group">
                                <a class="btn btn-default action-item" href="<?= url('admin/collections/create') ?>">
                                ...
                                <a class="btn btn-default buttons-reload" href="<?= url('admin/collections') ?>">
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="column-key-status">
                                            <div class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-mini"
                                                ...
                                                <input data-id="{{ $value['id'] }}"
                                                       ...
                                                       data-table="collections" data-column="released"
                                                       type="checkbox"
                                        ...
                                        <td class="text-center">
                                            <div class="table-actions">
                                                <a href="{{ url('admin/collections/' . $value['id']).'/edit' }}"
                            ...
                            <div class="datatables__info_wrap">
                                ...
                                <span class="dt-length-records">
                                    ...
                                    đến
                                    <span class="bold">{{ count($collections) }} </span>
                                    trong
                                    <span class="bold">{{ count($collections) }}</span>
                                    bản ghi
                                </span>
