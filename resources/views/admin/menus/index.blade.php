                    ...
                    <div class="table-responsive">
                        <div class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            <div class="dt-buttons btn-group">
                                <a class="btn btn-default action-item" href="<?= url('admin/menus/create') ?>">
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="column-key-status">
                                            <div class="bootstrap-switch bootstrap-switch-wrapper bootstrap-switch-mini"
                                                ...
                                                <input data-id="{{ $value['id'] }}"
                                                       ...
                                                       data-table="menus" data-column="released"
                                                       type="checkbox"
                                        ...
                                        <td class="text-center">
                                            <div class="table-actions">
                                                <a href="{{ url('admin/menus/' . $value['id']).'/edit' }}"
                                                   class="btn btn-icon btn-sm btn-primary tip">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a class="btn btn-icon btn-sm btn-danger tip btn-distroy" href="#"
                                                   data-action="{{url('admin/menus/' . $value['id'])}}"
                            ...
                            <div class="datatables__info_wrap">
                                ...
                                <span class="dt-length-records">
                                    ...
                                    đến
                                    <span class="bold">{{ count($menus) }} </span>
                                    trong
                                    <span class="bold">{{ count($menus) }}</span>
                                    bản ghi
                                </span>
