...
/* @var $category array \App\Category */
                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        ...
                        <div class="form-group required">
                            <div id="edit-slug-box" class="{{$category['slug'] ? '':'hidden'}}">
                                    ...
                                    <a class="permalink" target="_blank"
                                       href="{{ url('/') }}/{{$category['slug']}}">
                                        <span class="default-slug">
                                            {{ url('/') }}/<span id="editable-title">{{$category['slug']}}</span>
                                        </span>
                                    </a>
                                    <span class="default-slug hidden">
                                        {{ url('/') }}/
                                        <span id="editable-title">
                                            <input title="" type="text" id="new-slug" value="{{$category['slug']}}"
                            ...
                            <input type="hidden" id="current-slug" name="slug" value="{{$category['slug']}}">
                        </div>
                        ...
                        <div class="seo-preview">
                            ...
                            <div class="existed-seo-meta">
                                ...
                                <div class="page-url-seo ws-nm">
                                    <p>
                                        <?= url('/'); ?>/<span class="page-slug-seo">{{$category['slug']}}</span>
                                    </p>
                                </div>
                ...
                <div class="widget-body">
                    <div class="image-box">
                        <div class="image-box-actions">
                            <div class="inside">
                                <img style="width: 100%;"
                                     src="{{$category['avatar'] ? asset($category['avatar']):asset('dashboard/img/placeholder.png')}}"
                                     class="fieldID attachment-266x266 size-266x266" alt="">
                                <input title="" type="hidden" id="fieldID" name="avatar"
                                       value="{{$category['avatar'] ? asset($category['avatar']):asset('dashboard/img/placeholder.png')}}">
