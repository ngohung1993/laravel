...
/* @var $categories array \App\Category */
...
@section('content')
    ...
    @push('scripts')
        ...
        <script src="{{ asset('dashboard/js/categories/category.js')}}"></script>
    @endpush
                                        ...
                                        <div class="table-responsive">
                                            <div id="table-menus_wrapper"
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                    <?php App\Helpers\FunctionHelpers::show_categories_table(App\Category::all()) ?>
                                                    </tbody>
                                                </table>
                                                ...
                                                <div class="datatables__info_wrap">
                                                    ...
                                                    <div class="dataTables_info" id="table-posts_info" role="status"
                                                        ...
                                                        <span class="dt-length-records">
                                                            ...
                                                            <span class="bold">{{count($categories)}}</span> trong
                                                            <span class="bold">{{count($categories)}}</span>
                        ...
                        <div class="tab-pane" id="tab_note">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <div class="dd" id="tree-5aa383cc537d1">
                                    <?php App\Helpers\FunctionHelpers::show_categories_nestable(App\Category::all()) ?>
                                </div>
                            </div>
                        </div>
                    </div>
