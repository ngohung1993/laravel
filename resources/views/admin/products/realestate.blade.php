                            ...
                            <div class="tab-content">
                                                    ...
                                                    <div id="table-menus_wrapper"
                                                        ...
                                                        <div class="dt-buttons btn-group">
                                                            ...
                                                            <a class="btn btn-default buttons-reload"
                                                               href="<?= url('admin/products/realestate') ?>"
                                ...
                                <div class="tab-pane" id="tab_note">
                                    <div class="box-header">
                                        ...
                                        <div class="btn-group">
                                            <a href="<?= url('admin/products/realestate') ?>" class="btn btn-info btn-sm  tree-5aa383cc537d1-save">
                                                <i class="fa fa-save"></i>
                                                Save
                                            </a>
                                        </div>
                                        <div class="btn-group">
                                            <a href="<?= url('admin/products/realestate') ?>"
