                ...
                <div class="tab-content">
                    <div class="tab-pane active">
                        <div class="form-group required @if ($errors->has('title')) has-error @endif">
                            ...
                            <input value="{{$product->title}}" placeholder="Nhập tiêu đề tại đây" title=""
                        ...
                        <div class="form-group required @if ($errors->has('link')) has-error @endif">
                            ...
                            <input value="{{$product->link}}" placeholder="Nhập link iframe" title=""
                ...
                <div class="widget meta-boxes">
                    ...
                    <div class="widget-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$product->acreage}}" title=""
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$product->province_id}}" title=""
                                           type="text" class="form-control" name="province_id"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$product->district_id}}" title=""
                                           type="text" class="form-control" name="district_id"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$product->unit_id}}" title=""
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$product->price}}" title=""
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{$product->address}}" title=""
                                            ...
                                            <div>
                                                <div class="inside">
                                                    ...
                                                    <div id="list-img" class="thumbnails ui-sortable">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="file-thumbnail-footer">
                                                                ...
                                                                <div class="file-actions">
                                                                    <div class="file-footer-buttons">
                                                                        <button type="button" <?= $product->isNewRecord ? '' : 'data-auto="1" data-id="' . $value['id'] . '"' ?>
                                                                                class="btn btn-xs btn-default"
                                                                                onclick="deleteFile(event)">
                                                    ...
                                                    <div class="spanButtonPlaceholder block-upload-item"
                                                        ...
                                                        <?php endif;?>
                                                        <?php if (!$product->isNewRecord): ?>
                                                        <input data-auto="1" data-id="<?= $product['id'] ?>"
                                                               data-column-parent-id="product_id"
                        ...
                        <div class="seo-preview">
                            ...
                            <div class="existed-seo-meta">
                                ...
                                <div class="page-url-seo ws-nm">
                                    <p>
                                        <?= (new Request())->root(); ?>
                                        <span class="page-slug-seo">{{$product->slug}}</span>
                                    </p>
                                </div>
                    ...
                    <div class="misc-pub-section">
                        <div class="form-group">
                            <input type="checkbox" title="" name="status"
                                   class="minimal none-action" {{$product->status ? 'checked':''}}>
                        ...
                        <div class="form-group">
                            <input type="checkbox" title="" name="display_homepage"
                                   class="minimal none-action" {{$product->display_homepage ? 'checked':''}}>
                        ...
                        <div class="form-group">
                            <input type="checkbox" title="" name="featured"
                                   class="minimal none-action" {{$product->featured ? 'checked':''}}>
                ...
                <div class="widget-body">
                    <div class="image-box">
                        <div class="image-box-actions">
                            <div class="inside">
                                <img style="width: 100%;"
                                     src="{{$product->avatar ? asset($product->avatar):asset('dashboard/img/placeholder.png')}}"
                                     class="fieldID attachment-266x266 size-266x266" alt="">
                                <input title="" type="hidden" id="fieldID" name="avatar"
                                       value="{{$product->avatar ? asset($product->avatar):asset('dashboard/img/placeholder.png')}}">
                                <a href="{{ asset('/library/filemanager/dialog.php?type=1&field_id=fieldID&relative_url=1') }}"
                                   style="{{$product->avatar ? 'display:none':''}}"
                                   class="thumbnail-fieldID frame-btn">Đặt ảnh dại diện</a>
                                <a href="javascript:void(0)" style="{{$product->avatar ? '':'display:none'}}"
