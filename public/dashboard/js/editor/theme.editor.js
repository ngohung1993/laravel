...
let editor = {
    ...
    main: {
        ...
        submit_setting_theme: function () {
            ...
            $.ajax({
                url: base + '/api/ajax/submit-setting-theme',
                type: "POST",
        ...
        get_custom_field: function (id) {
            $.ajax({
                url: base + '/api/ajax/get-custom-field',
                type: "POST",
                data: {
                    id: id
                },
                success: function (result) {
                    if (result.data) {
                        ...
                        $('#custom-field-id').val(result.data['id'])
                    }
                }
            });
        },
        update_content_custom_field: function () {
            ...
            $.ajax({
                url: base + '/api/ajax/update-content-custom-field',
                type: "POST",
                data: {
        ...
        copy_custom_field: function (id, event) {
            ...
            if (r === true) {
                $.ajax({
                    url: base + '/api/ajax/copy-custom-field',
                    type: "POST",
                    data: {
                        id: id,
                    },
        ...
        delete_custom_field: function (id, event) {
            ...
            if (r === true) {
                $.ajax({
                    url: base + '/api/ajax/delete-custom-field',
                    type: "POST",
                    data: {
                        id: id,
                    },
